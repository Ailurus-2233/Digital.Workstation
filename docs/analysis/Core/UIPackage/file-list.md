...
- 关键类型：`public static class Icons`（行 7），含 15 个 `public const string`：
  `Settings`(12)、`DashBoard`(18)、`Properties`(22)、`Outline`(28)、`Output`(34)、`Log`(40)、`Tasks`(46)、`ChevronDown`(51)、`ChevronRight`(56)、`PanelLeft`(60)、`PanelBottom`(64)、`PanelRight`(70)、`Exit`(75)、`About`(80)、`Ready`(86)。

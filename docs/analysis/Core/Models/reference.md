...
Prism.Events.PubSubEvent<T>（Prism 包）
  ...
  ├─ SettingChangedEvent         ──负载──▶ SettingChanged (record: SettingId/NewValue，ADR-0006 决策 3)

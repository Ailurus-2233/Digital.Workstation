...
public sealed class SettingGroupAttribute(string name) : Attribute
{
    ...
    /// <summary>
    ///     分组在设置页分组树中的排序权重，小者靠前；同名分组多处声明冲突时取最小值（同 ADR-0001 (https://github.com/Ailurus-2233/Digital.Workstation/blob/main/docs/adr/0001-attribute-menu-registration.md) 决策 4）
    /// </summary>
